...
IF COL_LENGTH('${schemaName}.${env_1.env.TABLE_PREFIX}_entries', 'cod_uf_oper') IS NULL
BEGIN
  ALTER TABLE ${entriesTable} ADD [cod_uf_oper] NVARCHAR(10) NULL;
END;

IF COL_LENGTH('${schemaName}.${env_1.env.TABLE_PREFIX}_entries', 'desc_uf_oper') IS NULL
BEGIN
  ALTER TABLE ${entriesTable} ADD [desc_uf_oper] NVARCHAR(100) NULL;
END;

IF COL_LENGTH('${schemaName}.${env_1.env.TABLE_PREFIX}_entries', 'cod_mun_oper') IS NULL
BEGIN
  ALTER TABLE ${entriesTable} ADD [cod_mun_oper] NVARCHAR(20) NULL;
END;

IF COL_LENGTH('${schemaName}.${env_1.env.TABLE_PREFIX}_entries', 'desc_mun_oper') IS NULL
BEGIN
  ALTER TABLE ${entriesTable} ADD [desc_mun_oper] NVARCHAR(255) NULL;
END;

IF COL_LENGTH('${schemaName}.${env_1.env.TABLE_PREFIX}_entries', 'id_operacao') IS NULL
BEGIN
...
IF COL_LENGTH('${schemaName}.${env_1.env.TABLE_PREFIX}_items', 'num_no_fabric') IS NULL
BEGIN
  ALTER TABLE ${itemsTable} ADD [num_no_fabric] NVARCHAR(255) NULL;
END;

IF COL_LENGTH('${schemaName}.${env_1.env.TABLE_PREFIX}_items', 'tipo') IS NULL
BEGIN

...
exports.buildCollectiveTrainingSharePointFolder = buildCollectiveTrainingSharePointFolder;
...
function formatFolderDatePtBrSafe(dateValue) {
...
function buildCollectiveTrainingSharePointFolder(params) {
    const obraSegment = sanitizeFolderSegment(params.obraLocal || "Matriz", "Matriz");
    const turmaFolderName = sanitizeFolderSegment(`Treinamento Coletivo ${formatFolderDatePtBrSafe(params.turma.INICIADO_EM)}`, "Treinamento Coletivo");

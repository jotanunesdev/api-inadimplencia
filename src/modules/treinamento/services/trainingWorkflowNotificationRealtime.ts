...
import { getTrainingWorkflowNotificationSnapshot } from "../models/trainingWorkflowNotificationModel"
...
export async function broadcastTrainingWorkflowNotificationSnapshot(
  username: string,
) {
...
export async function openTrainingWorkflowNotificationStream(
  request: Request,
  response: Response,
  username: string,
) {

...
function mapHeader(input: EntryRecordInput['header']): EntryHeader {
  return {
    ...
    codUfOper: toNullableString(input?.codUfOper),
    descUfOper: toNullableString(input?.descUfOper),
    codMunOper: toNullableString(input?.codMunOper),
    descMunOper: toNullableString(input?.descMunOper),
    idOperacao: toNullableString(input?.idOperacao),
  ...
  public async getEntryById(entryId: string): Promise<EntryRecord> {
    ...
    const entryRecord: EntryRecord = {
      ...
      header: {
        ...
        codUfOper: toNullableString(headerRow.cod_uf_oper),
        descUfOper: toNullableString(headerRow.desc_uf_oper),
        codMunOper: toNullableString(headerRow.cod_mun_oper),
        descMunOper: toNullableString(headerRow.desc_mun_oper),
        idOperacao: toNullableString(headerRow.id_operacao),
